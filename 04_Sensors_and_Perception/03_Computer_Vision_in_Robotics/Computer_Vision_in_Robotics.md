...
* **Navigate autonomously:** Build maps ([[SLAM]]), estimate their own motion ([[Visual_Odometry]]), [[Localization|localize]] themselves, and follow paths while avoiding obstacles.
...
* **[[Visual_Odometry]] (VO):** Estimating the robot's egomotion incrementally by tracking the apparent motion of visual features in the camera images. Often combined with [[IMU_Sensors]] data (Visual-Inertial Odometry - VIO) for robustness.
...
* **Place Recognition:** Identifying if a currently viewed scene corresponds to a previously visited location, crucial for [[Loop_Closure]] in SLAM and global localization.
...
Computer vision employs a vast range of algorithms, evolving rapidly with advances in [[Machine_Learning]].
...
* **Machine Learning & Deep Learning:**
    * *[[Deep_Learning]]:* Dominates many current state-of-the-art results.
...
* **Data Requirements:** [[Deep_Learning]] models often require large amounts of labeled training data.
